...
from contextvit.backbone.vision_transformer import Block, PatchEmbed
from contextvit.utils import trunc_normal_
...
class ContextInferenceNetwork(nn.Module):
    ...
    def __init__(
        ...
        assert len(context_keys) == 1,\
                "We only support having one context token in this version."
